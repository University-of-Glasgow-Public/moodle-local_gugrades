...
/**
 * Test functions around twin columns and reassessments.
 ...
 */
final class mgu_1402_two_columns_test extends \local_gugrades\external\gugrades_aggregation_testcase {
    /**
     ...
     * @return void
     */
    public function xtest_resit_with_simple_grade_items(): void {
        global $DB;
     ...
     * @return void
     */
    public function xtest_resit_with_complex_grade_items(): void {
        global $DB;
     ...
     * @covers \local_gugrades\external\get_aggregation_page::execute
     */
    public function xtest_resit_aggregation(): void {
