...
/**
 * Define function get_capture_export_options
...
class get_capture_export_options extends external_api {
    ...
    public static function execute($courseid, $gradeitemid, $groupid) {
        ...
        return \local_gugrades\api::get_capture_export_options($courseid, $gradeitemid, $groupid);
    }
    ...
    public static function execute_returns() {
        return new external_multiple_structure(
            new external_single_structure([
                ...
                'description' => new external_value(PARAM_TEXT, 'Description of grade type'),
