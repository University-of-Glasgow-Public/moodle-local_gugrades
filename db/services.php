...
$services = [
    'local_gugrades' => [
        'functions' => [
            ...
            'local_gugrades_cleanup_integrity_errors',
...
$functions = [
    ...
    'local_gugrades_reset_grade_item' => [
        ...
        'capabilities' => 'local/gugrades:resetassessment,local/gugrades:removeremovedassessment',
        'description' => 'Completely reset MyGrades data for a single assessment.',
        'type' => 'write',
        'ajax' => true,
    ],
    'local_gugrades_reset_user_grades' => [
        'classname' => 'local_gugrades\external\reset_user_grades',
        'capabilities' => 'local/gugrades:removeuserdata',
        'description' => 'Completely reset MyGrades data for a single user.',
        'type' => 'write',
        'ajax' => true,
    ],
    'local_gugrades_cleanup_integrity_errors' => [
        'classname' => 'local_gugrades\external\cleanup_integrity_errors',
        'capabilities' => 'local/gugrades:removeuserdata,local/gugrades:removeremovedassessment',
        'description' => 'Clean unenrolled-user and removed-assessment integrity errors the current user may remove.',
        'type' => 'write',
        'ajax' => true,
    ],
    'local_gugrades_delete_capture_column' => [
