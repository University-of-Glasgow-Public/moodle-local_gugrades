...
$functions = [
    ...
    'local_gugrades_reset_grade_item' => [
        'classname' => 'local_gugrades\external\reset_grade_item',
        'capabilities' => 'local/gugrades:resetcourse',
        'description' => 'Completely reset MyGrades data for a single assessment.',
        'type' => 'write',
        'ajax' => true,
    ],
    'local_gugrades_delete_capture_column' => [
        'classname' => 'local_gugrades\external\delete_capture_column',
        'capabilities' => 'local/gugrades:resetcourse',
